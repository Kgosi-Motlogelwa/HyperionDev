// Test
const main = () => {
  const inputValue: number = +(<HTMLInputElement>(
    document.getElementById("numberToBeConverted")
  )).value;
  ...
  console.log(<HTMLInputElement>document.getElementById("numberToBeConverted"));
  const cases = [
...
const convert_trillions = (num: number) => {
  if (num === 1000000000000) {
    ...
    return (
      convert_billions(Math.floor(num / 1000000000000)) +
      " trillion, " +
...
const convert_billions = (num: number) => {
  if (num === 1000000000) {
    ...
    return (
      convert_millions(Math.floor(num / 1000000000)) +
      " billion, " +
...
const convert_millions = (num: number) => {
  if (num === 1000000) {
    ...
    return (
      convert_thousands(Math.floor(num / 1000000)) +
      " million, " +
